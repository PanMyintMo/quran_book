...
class AppTheme {
  ...
  static ThemeData get light {
    ...
    return ThemeData(
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        ...
        selectedLabelStyle: TextStyle(color: kAppPrimaryColor, fontSize: 12),
  ...
  static ThemeData get dark {
    ...
    return ThemeData(
      ...
      bottomNavigationBarTheme: const BottomNavigationBarThemeData(
        backgroundColor: _darkScaffold,
        selectedItemColor: kProfileAccentYellow,
        unselectedItemColor: Colors.white70,
        selectedIconTheme: IconThemeData(color: kProfileAccentYellow),
        unselectedIconTheme: IconThemeData(color: Colors.white70),
        selectedLabelStyle: TextStyle(color: kProfileAccentYellow, fontSize: 12),
        unselectedLabelStyle: TextStyle(color: Colors.white70, fontSize: 12),
        type: BottomNavigationBarType.fixed,
      ),
      drawerTheme: const DrawerThemeData(
        backgroundColor: _darkScaffold,
